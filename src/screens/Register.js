        ...
        <div>
            ...
            <div className='row justify-content-center mt-5'>
                <div className='col-md-5'>
                    ...
                    <div className="bs">
                        <h2>Register</h2>
                        <input type='text' className='form-control newlog' placeholder='name' value={name} onChange={(e) => setName(e.target.value)}/>
                        <input type='email' className='form-control newlog' placeholder='email' value={email} onChange={(e) => setEmail(e.target.value)}/>
                        <input type='password' className='form-control newlog' placeholder='password' value={password} onChange={(e) => setPassword(e.target.value)}/>
